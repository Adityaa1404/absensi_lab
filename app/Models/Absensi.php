...
class Absensi
{
    ...
    /**
     * Mengambil data pendaftaran yang berstatus 'diterima' untuk asdos tertentu.
     */
    ...
    /**
     * Menambahkan absensi baru oleh asdos.
     */
    ...
    /**
     * Mengambil riwayat seluruh absensi milik seorang asdos.
     */
    public function getByAsdos(int $asdosId): array
    {
        $sql = "SELECT a.*, k.nama_kegiatan
                FROM absensi a
                INNER JOIN pendaftaran_kegiatan p ON a.pendaftaran_id = p.id_pendaftaran
    ...
    /**
     * Mengambil semua data absensi berdasarkan ID pendaftaran.
     */
    public function getByPendaftaran(int $pendaftaranId): array
    {
        $stmt = $this->db->prepare(
            "SELECT * FROM absensi WHERE pendaftaran_id = :pendaftaran_id ORDER BY created_at DESC"
        );
