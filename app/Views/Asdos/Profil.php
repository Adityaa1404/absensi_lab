...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white border border-slate-200 p-5 sm:p-6 rounded-xl shadow-xs">
        <h2 class="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">Pengaturan Profil Asisten Dosen</h2>
        <p class="text-xs sm:text-sm text-slate-500 mt-0.5">Kelola data pribadi, informasi kontak, dan kata sandi akun asisten Anda.</p>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 sm:p-6 shadow-xs flex flex-col sm:flex-row items-center gap-5">
        ...
        <div class="text-center sm:text-left flex-1">
            <div class="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                <h3 class="text-lg sm:text-xl font-bold text-slate-900"><?= htmlspecialchars($user['nama'] ?? 'Asdos') ?></h3>
                <span class="px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider bg-emerald-50 text-emerald-700 border border-emerald-200">
                    <?= htmlspecialchars($user['role'] ?? 'asdos') ?>
                </span>
            </div>
            <p class="text-xs font-mono text-slate-600 mt-1">NPM: <strong><?= htmlspecialchars($user['identity_number'] ?? '-') ?></strong></p>
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 sm:p-6 shadow-xs">
        ...
        <form method="POST" action="index.php?page=asdos/profil" class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        class="w-full border border-slate-300 rounded-lg px-3.5 py-2 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#1867c0]/20 focus:border-[#1867c0] transition duration-150"
                    >
                </div>
            ...
            <div class="flex justify-end pt-2">
                <button
                    type="submit"
                    class="bg-[#1867c0] hover:bg-[#14529d] text-white text-xs font-semibold py-2 px-5 rounded-lg transition duration-150 shadow-xs flex items-center gap-1.5"
                >
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 sm:p-6 shadow-xs">
        ...
        <form method="POST" action="index.php?page=asdos/profil" class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        class="w-full border border-slate-300 rounded-lg px-3.5 py-2 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#1867c0]/20 focus:border-[#1867c0] transition duration-150"
            ...
            <div class="flex justify-end pt-2">
                <button
                    type="submit"
                    class="bg-slate-800 hover:bg-slate-900 text-white text-xs font-semibold py-2 px-5 rounded-lg transition duration-150 shadow-xs flex items-center gap-1.5"
                >
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
