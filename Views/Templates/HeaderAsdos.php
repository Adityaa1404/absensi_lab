    ...
    <header class="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-20 md:h-24">
            ...
            <div class="flex items-center gap-3 md:gap-4">
                ...
                <div>
                    <h1 class="text-lg sm:text-xl md:text-2xl font-bold text-gray-800 leading-tight"><?= htmlspecialchars($_SESSION['nama'] ?? 'Asdos') ?></h1>
            ...
            <div class="flex items-center gap-4 md:gap-6">
                <div class="hidden sm:block text-right">
                    ...
                    <p class="text-xs md:text-sm text-gray-500 font-mono">NPM: <?= htmlspecialchars($_SESSION['identity_number'] ?? '-') ?></p>
                </div>
